...
package at.bitfire.davdroid.util.dateformat
...
internal fun formatLastSync(
    ...
    val day = when {
        ...
        // Six days, not seven: seven days back falls on the current weekday, so the label would
        // repeat the name of the day the reader is standing in.
        daysBack <= 6L -> words.weekdays.getValue(syncedAt.dayOfWeek)
