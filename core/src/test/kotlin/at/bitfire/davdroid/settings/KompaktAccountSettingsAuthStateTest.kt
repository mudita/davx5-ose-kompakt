...
// Robolectric because AppAuth serializes through org.json, a stub that throws on a plain JVM test --
// under which the unparseable case would pass without parsing anything.
...
class KompaktAccountSettingsAuthStateTest {
    ...
    fun parsesWhatTheStoreActuallyHolds() {
        // Round-tripped, so the test cannot pass against a JSON shape AppAuth does not produce.
