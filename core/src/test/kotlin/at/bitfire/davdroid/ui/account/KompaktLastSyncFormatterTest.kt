...
class KompaktLastSyncFormatterTest {
    ...
    @Test
    fun sixDaysBackIsStillAWeekday() {
        assertEquals("Fri 11:00", format("2026-05-08T11:00:00Z"))
    }

    @Test
    fun theSeventhDayBackIsTheLastWeekday() {
        // Seven days back shares today's weekday, and reads unambiguously only because the current
        // day renders as its own word rather than as "Thu".
        assertEquals("Thu 11:00", format("2026-05-07T11:00:00Z"))
    }
