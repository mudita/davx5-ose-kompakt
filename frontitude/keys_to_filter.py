...
filter_keys = [
    ...
    '<resources',
    '</resources>',
    'calendar_accountsync_button_synchronizenow',
    ...
    'calendar_accountsync_dialog_h1_permissionsgranted',
    ...
    'calendar_accountsync_error_dialog_h1_yoursyncisoff',
    ...
    'common_all_error_h1_youreusingoffline',
    'common_button_disable',
    'common_button_notnow',
    'common_button_ok',
    'common_button_skip',
